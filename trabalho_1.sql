...
(1, 'Notebook X1', 'Notebook ultrafino com 16GB RAM e SSD 512GB'),
...
INSERT INTO ITEM (Series_number, Value, Id_model) VALUES
(1001, 4500, 1),
(1002, 4600, 1),
(1003, 4550, 1),
(2001, 2500, 2),
...
-- CLIENTES
INSERT INTO CLIENT (CPF, Name, Birth_date, Gender) VALUES
('123.456.789-00', 'Ana Silva', '1990-05-12', 'F'),
...
INSERT INTO EVALUATION (CPF_client, Series_number_item, Classification) VALUES
('123.456.789-00', 1001, '5'),
('987.654.321-00', 2002, '4'),
('111.222.333-44', 3001, '3');

-- VENDAS (cliente compra item específico)
INSERT INTO SALE (CPF_client, Series_number_item, Value_sale, Date, Hour) VALUES
('123.456.789-00', 1001, 4400, '2025-09-01', '10:30:00'),
